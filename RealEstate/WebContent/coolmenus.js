...
oCMenu.makeMenu('top0','','<b>Plots</b>','','')
    oCMenu.makeMenu('sub00','top0','&nbsp;New Plot&nbsp;','AddPlot.html','Frame3')
    oCMenu.makeMenu('sub01','top0','&nbsp;View','ViewPlot.html','Frame3')
    oCMenu.makeMenu('sub02','top0','&nbsp;Edit','EditPlot.html','Frame3')
oCMenu.makeMenu('top1','','<b>Appartments</b>','','')
    oCMenu.makeMenu('sub10','top1','&nbsp;New Appartment&nbsp;','AddAppartment.html','Frame3')
    oCMenu.makeMenu('sub11','top1','&nbsp;View','ViewAppartments.jsp','Frame3')
oCMenu.makeMenu('top2','','<b>&nbsp;Sales&nbsp;</b>','','')
    oCMenu.makeMenu('sub20','top2','&nbsp;Sales&nbsp;>','')
		oCMenu.makeMenu('sub200','sub20','&nbsp;New Entry','SalesEntry.html','Frame3')
        oCMenu.makeMenu('sub201','sub20','&nbsp;Alter Details','AlterSalesEntry.html','Frame3')
...
oCMenu.makeMenu('top3','','<b>&nbsp;Employees&nbsp;</b>','','')
    oCMenu.makeMenu('sub30','top3','&nbsp;Add Employee&nbsp;','AddEmployee.html','Frame3')
