...
public class PolicyModify extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            pstmt = con.prepareStatement((new StringBuilder("update policies set policyname=?,policyterm=?,policyamount=?,policyfaceamount=?,policyinterest=?, bonusperiod=?, bonusrate=? where policyid=")).append(id).toString());
