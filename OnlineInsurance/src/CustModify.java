...
public class CustModify extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            pstmt = con.prepareStatement((new StringBuilder("update customer set custname=?,custfname=?,custage=?,custqual=?,custaddress=?,custoccupation=? where custid=")).append(id).toString());
