...
public class ManagerModify extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            ...
            pstmt = con.prepareStatement((new StringBuilder("update branchmgr set branchmgrname=?,branchmgrfname=?,branchmgrage=?,branchmgrsex=?,branchmgrqual=?,branchmgraddress=?,branchname=?,branchmgrjoindate=? where  branchmgrid=")).append(id).toString());
