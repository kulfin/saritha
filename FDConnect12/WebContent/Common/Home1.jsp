...
document.getElementById('header_label').innerHTML="SB-JobCard Assignement";
...
else if(pageName=="../Connect/MndJobCardAssignment.jsp")
	document.getElementById('header_label').innerHTML="MnD Job Card Assignment";
	
else if(pageName=="../Connect/Jobcard_Report.jsp")
	document.getElementById('header_label').innerHTML="MIS Tracker";
	...
	response.sendRedirect("../Login.jsp");
		...
		<li> <a href="#" class="menulink">Connect</a>
			<ul>
				...
				<li><a href="../Connect/MeasurementSheet.jsp">Measurement Sheet</a></li>	
				<li>
					<a href="#" class="sub">Job Card</a>
					<ul>
						<li><a href="../Connect/JobCardStatusView.jsp">Job Card Status Update</a></li>					
					</ul>
				</li>
			</ul>
		</li>
		<li><a href="#" class="menulink">Cost Estimation</a>
			<ul>
			   ...
			   <li><a href="../RFPR/SearchBomView.jsp" >Consolidate Cost Estimation</a></li>
	           <!-- <li><a href="../RFPR/ViewBomView.jsp" >View BOM</a></li>  -->
	                   <li><a href="../RFPR/ViewBomView.jsp" >View Cost Estimation</a></li>
			   			
			</ul>	
		</li>
		<li> <a href="#" class="menulink">Report</a>
				<ul>
					<li>
						<a href="#" class="sub">Tracker</a>
						<ul>
							<li><a href="../Connect/Jobcard_Report.jsp">MIS Tracker</a></li>	
							<li><a href="../Connect/MisTracker_ExceptionReport.jsp">MIS Exception Tracker</a></li>					
							<li><a href="../Connect/MisTracker_Edge_Cental_Co_Ordinator_Report.jsp">MIS Central Co-ordinator Tracker</a></li>
							<li><a href="../Connect/MisTracker_Edge_Regional_Co_Ordinator_Report.jsp">MIS Regional Co-ordinator Tracker</a></li>
						</ul>
					</li>
				</ul>
		</li>
		...
		<li><a href="../Connect/MeasurementSheet.jsp">Measurement Sheet</a></li>	
			...
			<li>
				<a href="#" class="sub">Job Card</a>
				<ul>
					<li class="topline"><a href="../Connect/JobCardAssignment.jsp">SB Job Card Assignment</a></li>					
					<li><a href="../Connect/MndJobCardAssignment.jsp">MnD Job Card Assignment</a></li>
					<li><a href="../Connect/JobCardStatusView.jsp">Job Card Status Update</a></li>					
				</ul>
			</li>
		</ul>
