...
<link rel="stylesheet" type="text/css"
	href="../css/Connect/mis_tracker_exception_report.css" />
...
<script type="text/javascript" src="../js/Connect/MisTracker_edge_regional_co_ordinator_report.js"></script>
<script type="text/javascript">
...
<div>	
	...
	<jsp:param name="title" value="MIS TRACKER EDGE REGIONAL CO-ORDINATOR"/>
	</jsp:include>
</div>
<!--/header div -->
