...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_retail_client.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />
<script type="text/javascript" src="../js/Common/jquery.min.js"></script>
<script type="text/javascript" src="../js/Admin/manage_retail_client.js">
</script>
...
%>
<!-----   Body   ----->
<body onload="getRetailClient();">

<!-- div to include header -->
<div>	
	<jsp:include page="../Common/Home.jsp">
	<jsp:param name="title" value="Manage Retail Client"/>
	</jsp:include>
</div>
...
<div id="content_operation_button_div"><input style="width: 140px;" type="button"
	value="Delete" onclick="deleteRetailClient('content_view_table')"></div>
<!-- /Content Operation Button Div -->
...
<form action="#">
<div id="content_add_label_div"><label id="content_add_label">Add Retail Client</label></div>
...
<tr>
<td>Client Name:</td>
<td><input id="add_operation_retail_client_name_input" type="text" size="35" maxlength="25"></td>
</tr>
<tr>
<td>Address:</td>
<td><textarea id="add_operation_address_input" rows="2" style="width:240px;resize:none;" maxlength="255"></textarea></td>
</tr>
</table>
</div>
...
<form action="#">
<div id="content_update_label_div">Update Retail Client</div>
...
<td>Client Name:</td>
<td>
<input id="update_operation_retail_client_name_input" type="text" size="35">
<input id="update_operation_retail_client_id_input" type="hidden" >
</td>
</tr>

<tr>
<td>Address:</td>
<td><textarea id="update_operation_address_input" rows="2" style="width:240px;resize:none;" ></textarea></td>
</tr>
