...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_project_status.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />

<script type="text/javascript" src="../js/Admin/manage_project_status.js">
</script>
...
<div>	
	...
	<jsp:param name="title" value="Manage Project Status View"/>
	</jsp:include>
</div>
...
<form action="#">
<div style="position: relative; margin: 5px 0 0px 150px; color: #A90B0B; font-size: 17px; font-weight: bold; font-family: verdana;">ADD PROJECT STATUS</div>
<br />
<br />
<br />
<br />
...
<div style="position: relative; margin: 10px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">
	Project Name:<span style="margin: 0px 0 0px 20px;"> 
	<input id="addRoleName" name="roleName" type="text" size="35"></span></div>
<div style="position: relative; margin: 60px 0 0 175px;">
...
<form action="#">
<div style="position: relative; margin: 5px 0 0px 150px; color: #A90B0B; font-size: 17px; font-weight: bold; font-family: verdana;">UPDATE
PROJECT STATUS</div>
<br />
<br />
<br />
 
 <span style="position: relative; display: block; margin: 15px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">Project Status Name:
