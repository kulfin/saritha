...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_brand_category.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />
<script type="text/javascript" src="../js/Common/jquery.min.js"></script>
<script type="text/javascript" src="../js/Admin/manage_brand_category.js">
</script>
...
%>
<!-----   Body   ----->
<body onload="getBrandCategory();">

<!-- div to include header -->
<div>	
	<jsp:include page="../Common/Home.jsp">
	<jsp:param name="title" value="Manage Brand Category"/>
	</jsp:include>
</div>
...
<div id="content_operation_button_div"><input style="width: 140px;" type="button"
	value="Delete" onclick="deleteBrandCategory('content_view_table')"></div>
<!-- /Content Operation Button Div -->
...
<form action="#">
<div id="content_add_label_div"><label id="content_add_label">Add Brand Category</label></div>
...
<tr>
<td>Category Name:</td>
<td><input id="add_operation_brand_category_name_input" type="text" size="35" maxlength="25"></td>
</tr>
</table>
</div>
...
<form action="#">
<div id="content_update_label_div">Update Brand Category</div>
...
<td>Category Name:</td>
<td>
<input id="update_operation_brand_category_name_input" type="text" size="35">
<input id="update_operation_brand_category_id_input" type="hidden" >
</td>
</tr>
</table>
</div>
