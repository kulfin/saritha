...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_store_status.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />
<script type="text/javascript" src="../js/Common/jquery.min.js"></script>
<script type="text/javascript" src="../js/Admin/manage_store_status.js">
</script>
...
%>
<!-----   Body   ----->
<body onload="getStoreStatus();">

<!-- div to include header -->
<div>	
	<jsp:include page="../Common/Home.jsp">
	<jsp:param name="title" value="Manage Store Status"/>
	</jsp:include>
</div>
...
<div id="content_operation_button_div"><input style="width: 140px;" type="button"
	value="Delete" onclick="deleteStoreStatus('content_view_table')"></div>
<!-- /Content Operation Button Div -->
...
<form action="#">
<div id="content_add_label_div"><label id="content_add_label">Add Store Status</label></div>
...
<tr>
<td>Status Name:</td>
<td><input id="add_operation_store_status_name_input" type="text" size="35" maxlength="25"></td>
</tr>
<tr>
<td>Description:</td>
...
<form action="#">
<div id="content_update_label_div">Update Store Status</div>
...
<td>Status Name:</td>
<td>
<input id="update_operation_store_status_name_input" type="text" size="35">
<input id="update_operation_store_status_id_input" type="hidden" >
</td>
</tr>
