...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_material_element.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />

<script type="text/javascript" src="../js/Admin/manage_material_element.js">
</script>
...
<div>	
	...
	<jsp:param name="title" value="Manage Material Element Type"/>
	</jsp:include>
</div>
...
<form action="#">
<div style="position: relative; margin: 5px 0 0px 178px; color: #A90B0B; font-size: 17px; font-weight: bold; font-family: verdana;">ADD ELEMENT TYPE</div>
<br />
<br />
<br />
<br />

<div style="position: relative; margin: 10px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">Element Type
Name:<span style="margin: 0px 0 0px 20px;"><input name="elementName" id="elementName" type="text" size="40" maxlength="25"></span></div>
<div style="position: relative; margin: 60px 0 0 170px;"><input style="width: 140px;" type="button" onclick="return validateAddOperation(elementName)" value="SUBMIT" /></div>
</form>
...
<br />
 ...
 <span style="position: relative; display: block; margin: 15px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">Element Type Name:
