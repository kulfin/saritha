...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_trade.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />
<script type="text/javascript" src="../js/Common/jquery.min.js"></script>
<script type="text/javascript" src="../js/Admin/manage_trade.js">
</script>
...
%>
<!-----   Body   ----->
<body onload="getTrade();">

<!-- div to include header -->
<div>	
	<jsp:include page="../Common/Home.jsp">
	<jsp:param name="title" value="Manage Trade"/>
	</jsp:include>
</div>
<!-- body /main content-->
...
<div id="content_operation_button_div"><input style="width: 140px;" type="button"
	value="Delete" onclick="deleteTrade('content_view_table')"></div>
<!-- /Content Operation Button Div -->
...
<form action="#">
<div id="content_add_label_div"><label id="content_add_label">Add Trade</label></div>
...
<tr>
<td>Trade Name:</td>
<td><input id="add_operation_trade_name_input" type="text" size="35" maxlength="25"></td>
</tr>
</table>
</div>
...
<form action="#">
<div id="content_update_label_div">Update Trade</div>
...
<td>Trade Name:</td>
<td>
<input id="update_operation_trade_name_input" type="text" size="35">
<input id="update_operation_trade_id_input" type="hidden" >
</td>
</tr>
</table>
</div>
