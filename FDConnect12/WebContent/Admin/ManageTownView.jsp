...
<link rel="stylesheet" type="text/css" href="../css/Admin/manage_town.css" />
<%@page import="com.fd.App.*" %>
<link rel="icon" href=<%=ApplicationConstants.IMAGEPATH %> type="image/x-icon" />

<script type="text/javascript" src="../js/Admin/manage_town.js">
</script>
...
<div>	
	...
	<jsp:param name="title" value="Manage Town"/>
	</jsp:include>
</div>
...
<div
	style="position: relative; margin: 10px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">Town
Name:<span style="margin: 0px 0 0px 20px;"><input id="addTownName" name="townName" type="text" size="40" maxlength="25"></span></div>
<div style="position: relative; margin: 60px 0 0 170px;"><input style="width: 140px;" type="button"
	onclick="return validateAddOperation(townName)" value="SUBMIT" /></div>
</form>
...
<span
  ...
  <span
	style="position: relative; display: block; margin: 15px 0 0px 20px; font-size: 15px; color: rgb(70, 66, 66);">Town
Name:<span style="margin: 0px 0 0px 20px;"><input id="townName"
	name="townName" type="text" size="47"></span> <span
	style="margin: 0px 0 0px 0px;"><input id="townId" name="townId"
...
<input style="width: 140px;" type="button"
	onclick="return validateUpdateOperation(townId,townName)" value="UPDATE" />
