...
function validateAddOperation(townName)
{   
...
function validateUpdateOperation(townId,townName)
{   
	...
	if(document.getElementById("update_city_select").selectedIndex==0){
      ...
      updateTown(townIdVal,townNameVal);   	
 }


 

function showUpdateDiv(townId,townName){
...
function getCountry(subFlag,status)
{
	...
	xmlhttp.open("POST","ManageTownController.jsp",true);
...
function getTown(subFlag)
{
	...
	var outData="flag=get_town&cityId="+selectedCityIdForFilterOperation;
	xmlhttp.open("POST","ManageTownController.jsp",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send(outData);
...
function setTown(townName)
{
	...
	var outData="flag=set_town&countryId="+selectedCountryIdForFilterOperation+"&regionId="+selectedRegionIdForFilterOperation+"&stateId="+selectedStateIdForFilterOperation+"&cityId="+selectedCityIdForFilterOperation+"&townName="+townName;
	xmlhttp.open("POST","ManageTownController.jsp",true);
	xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	xmlhttp.send(outData);
}
...
function updateTown(townId,townName){
	...
	var outData="flag="+flag+"&countryId="+selectedCountryIdForUpdateOperation+"&regionId="+selectedRegionIdForUpdateOperation+"&stateId="+selectedStateIdForUpdateOperation+"&cityId="+selectedCityIdForUpdateOperation+"&townId="+townId+"&townName="+townName; 
