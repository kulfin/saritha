...
{   
	var elementNameVal  = elementName.value;
            	...
            	if(elementNameVal=="")
                {
                    alert("Please Enter Element Status Name");
                    elementName.focus();
                    return false;
...
{   
	...
	var elementIdVal=elementId.value;
      ...
      updateCountry(elementIdVal,elementNameVal);   	
...
function getCountry(subFlag)
{
	...
	xmlhttp.open("POST","ManageMaterialElementStatusController.jsp",true);
